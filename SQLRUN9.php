...
// Base SQL query
$sql = "SELECT c.email FROM customer AS c INNER JOIN rental AS r ON c.customer_id = r.customer_id WHERE r.return_date IS NULL"; // Placeholder for the WHERE clause conditions
